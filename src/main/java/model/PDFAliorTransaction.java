...
public class PDFAliorTransaction extends PDFObject {
    ...
    protected void setFields() {
        if (fields == null) {
            fields = new HashMap<>();
            String transactionPattern = Constants.valueOf("transactionData");
            fields.put("Payment_Posting_Date__c", new PDFObjectField<LocalDate>("paymentPostingDate",
                    new FieldTemplate<>(transactionPattern,
                            s -> LocalDate.parse(s, DateTimeFormatter.ofPattern("yyyy.MM.dd")), 0, 1)));
            fields.put("Transaction_Type__c", new PDFObjectField<String>("transactionType", new FieldTemplate<>(Constants.valueOf("transactionType"), s -> s, 0, 1)));
            ...
            fields.put("Payment_Date__c", new PDFObjectField<LocalDate>("paymentDate",
                    new FieldTemplate<>(transactionPattern,
